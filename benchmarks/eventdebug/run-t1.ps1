...
$outDir = 'C:\Java Developer\DAST\benchmarks\eventdebug\out\t1'
...
$containerName = 'eventdebug-t1-zap'
...
Write-AutomationConfig -ApiDocsFile $scannerApiDocsFile
